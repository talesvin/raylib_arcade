        ...
        BeginDrawing();
            ...
            for(int i = 0; i < lines; i++)
                for(int j = 0; j < line_pieces; j++)
                        DrawRectangle(pieces[i][j].x, pieces[i][j].y, pieces[i][j].width, pieces[i][j].height, pieces[i][j].color);
            ...
            for(int i = 0; i < lines; i++){
                for(int j = 0; j < line_pieces; j++){
                    if((ball.x >= pieces[i][j].x && ball.x <= pieces[i][j].x + pieces[i][j].width) &&
                    (ball.y >= pieces[i][j].y && ball.y <= pieces[i][j].y + pieces[i][j].height) &&
